...
> Cue reactivity는 흡연·음식·약물 cue가 유발하는 **craving·주의 편향·DMN/보상 회로 활성**을 묶는 상위 개념이다. 사용자 lab의 "hijacked brain"·[[concept-digital-therapeutics|DTx]]·electroceutical 라인의 핵심 표적 현상으로, cue reactivity를 **낮추는** 수단(인지 라벨링·tDCS·폐루프 자극)이 곧 치료 모듈 후보다.

# Cue reactivity (큐 반응성)

## 한 줄 요약
학습된 cue(담배·음식·약물 관련 자극)가 자동적으로 유발하는 craving·생리·신경 반응. 중독·과식의 재발·충동을 매개하며, incentive salience([[concept-incentive-sensitization]])의 행동적 표현.

## 핵심 내용
- **신경 substrate**: 보상 회로([[concept-nucleus-accumbens]]·[[concept-dopamine-reward-system]]·[[concept-orbitofrontal-cortex]]), 주의/현저성, 그리고 medial parietal DMN(precuneus/PCC). 인간 섬-덮개는 음식 cue를 선제적으로 부호화한다([[huang-2021-the-insulo-opercular-cortex-encodes]]).
- **음식 cue**: 인간 visual food cue fMRI 반응은 비만·GLP-1RA 상태에 따라 달라진다([[bae-2019-glucagon-like-peptide-1-receptor]]). 초가공식품 환경에서 cue reactivity는 과식의 통로([[lee-2025-hijacked-brain-modern-obesity-cue]]).
- **조절 수단**:
...
- [[perri-2021-transcranial-direct-current-stimulation]] · [[jeong-2024-efficacy-of-transcranial-direct]] — tDCS craving 조절.
