...
> closed-loop 신경조절 논리를 **섭식→강박(OCD)으로 이식**. 난치성 OCD 3인에서 **anteromedial OFC(amOFC) low-gamma가 증상 상태의 공유 biomarker**이고, **NAc-VeP 고주파 자극이 그 OFC gamma·강박 고통을 동반 감소**(인과 시사). 사용자 관점: NAc/OFC reward 회로의 **transdiagnostic 충동–강박 축**을 인간 침습 데이터로 보임 — LOC eating biomarker 작업과 같은 회로·같은 방법론이 정신질환 전반으로 확장됨을 시사.
...
- **증상 유발 과제**(노출치료 ExRP 모사): 5분 중립 → 5분 노출(강박 유발) → 이완, 매분 VAS 0–10 강박 고통.
- **biomarker**: **우측 amOFC low-gamma(30–55 Hz) 전력이 고증상(노출) 상태에서 3인 모두 일관 상승** — 코호트 공유 유일 주파수 변화(β=+0.103, p=0.0132). 유발 시행의 79%에서 고통↑+amOFC gamma↑ 동반(부호검정 p=0.0066). 대역: delta 1–4·theta 5–8·alpha 9–12·beta 13–30·**low-gamma 30–55**·high-gamma 65–115 Hz.
...
- [[concept-nucleus-accumbens]] — 자극 표적(NAc-VeP); OFC의 주 투사 대상.
- [[concept-responsive-neurostimulation]] — closed-loop 논리를 강박으로 확장.
- [[wu-2018-closing-the-loop-on]] · [[shivacharan-2022-pilot-study-of-responsive-nucleus]] — 같은 NAc closed-loop 패러다임의 섭식편(transdiagnostic 연결).
- [[concept-loss-of-control-eating]] — 충동–강박 축의 식이 짝.
- [[concept-dopamine-reward-system]] — OFC–NAc reward 루프.
