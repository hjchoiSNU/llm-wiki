...
> 사용자(최형진)가 8인 공저로 집필 중인 **식락학(Food Hedonology) 교재**의 전체 구조 지도. "맛의 즐거움"을 식품화학·신경미식학·뇌 보상·호르몬·미래기술까지 6 Part·28 챕터로 통합하는 신생 discipline 정립 프로젝트. 사용자에게의 의미: 본 wiki의 섭식·보상·호르몬 지식이 **교재 챕터로 출력되는 목적지** — 특히 사용자 담당 4개 챕터(Ch 18 호르몬 / Ch 20 opioid·dopamine liking-wanting / Ch 24 음식 갈망·중독 / Ch 25 비만 근본 치료)가 wiki의 [[concept-dopamine-reward-system]]·[[concept-food-addiction]]·[[lee-2025-hijacked-brain-modern-obesity-cue]]·[[concept-need-motivation-pleasure-utility]]와 직접 연결된다. 이미 정리된 [[overview-sikrakhak-ch18-appetite-hormones|Ch 18]]이 그 첫 산출물.

# 식락학(食樂學, Food Hedonology) 교재 프로젝트

> 출처: 출판 회의 안건(`raw/출판 회의 안건_0406 수정 v2.docx`). 본 페이지는 **교재의 구조·집필 분담**을 기록하며, 회의 행정 세부(연락처 등)는 생략한다.

## 한 줄 요약
"음식이 유발하는 즐거움"을 과학적으로 다루는 신생 분야 **Food Hedonology(식락학)**의 국내 첫 교재. 8인 공저, 6 Part·28 챕터. 식품 성분·감각(신경미식학)·뇌 보상 회로·호르몬·미래 식품기술을 아우름.

## 집필진 (8인)
김유리 · 박태현 · 이광근 · 이성준 · 정서진 · 최명환 · **최형진**([[person-choi-hyung-jin]], 사용자) · 홍재희

## 전체 목차 (28 챕터)

### Part I. 음식 즐거움의 기초 (Foundations of Food Pleasure)
- Ch 1. 식락학 입문: 음식이 유발하는 즐거움 과학의 정의 — 박태현
- Ch 2. 음식 즐거움의 진화적 기원 — 이성준

### Part II. 기호적 반응을 유발하는 음식 구성 요소
- Ch 3. 향미 분자: 당·산·아미노산과 맛의 화학 — 이광근
- Ch 4. 향기 화합물: 향을 결정하는 휘발성 분자 — 이광근
- Ch 5. 식감과 다량영양소(탄수화물·지방·단백질의 구강감각) — 홍재희
- Ch 6. 지방과 음식 즐거움(향미 전달·포만 신호 매개체) — 정서진
- Ch 7. 음식의 중독적 속성: 당·지방·소금 — 홍재희
- Ch 8. 영양과 건강의 함의: 영양소·즐거움·대사질환 — 김유리

### Part III. 신경미식학 (Neurogastronomy) — 식품 인지 감각 시스템
- Ch 9. 미각 시스템: 단·짠·신·쓴·감칠맛 그 너머 — 박태현
- Ch 10. 후각 시스템: 향의 지각·인지 — 박태현
- Ch 11. 식감·구강감각·시각·청각 — 박태현
- Ch 12. 다감각 통합: 뇌의 향미 형성 — 최명환

### Part IV. 뇌와 보상 경로 (The Brain and Reward Pathways)
- Ch 13. 즐거움의 신경 회로: 도파민·엔도르핀·보상 시스템 — 최명환 → [[concept-dopamine-reward-system]]
- Ch 14. 기호적 섭식 vs 항상성 섭식 — 최명환 → [[concept-need-motivation-pleasure-utility]]
- Ch 15. 음식 즐거움 뇌 영역: 시상하부·편도체·안와전두피질 — 최명환 → [[concept-lateral-hypothalamus]]·[[concept-basolateral-amygdala]]·[[concept-orbitofrontal-cortex]]
- Ch 16. 영양과 신경생물학적 기전: 뇌 보상회로의 영양학적 조절·질병 — 김유리
- Ch 17. 식품기호와 정신건강: 우울·중독·섭식장애 — 홍재희 → [[concept-loss-of-control-eating]]
...
- [[lee-2025-hijacked-brain-modern-obesity-cue]] — Ch 25 비만 치료의 직접 소스(사용자 lab).
