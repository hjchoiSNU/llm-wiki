...
## 정의
Scavenger receptor class B family의 88 kDa ditopic 막당단백질. **long-chain fatty acid(LCFA)를 나노몰 친화도로 결합**하는 큰 세포외 소수성 pocket + 짧은 세포내 tail 2개(Src kinase 결합). 지방 수송·감지·scavenger·세포부착 등 다기능. FFAR1/4(GPCR)와 달리 **G-protein 비의존**, 세포내 tail이 Src-PTK를 활성화.
...
## 하류 신호(미뢰)
LCFA → CD36 결합 → **Src-PTK 인산화** → 세포내 Ca²⁺ 급증 → **세로토닌·노르에피네프린 방출** → 미주·설인 구심성 활성 → 뇌간 **NST**(El-Yassimi 2008, Gaillard 2008). 약리 억제제 **SSO**(sulfo-N-succinimidyl oleic acid)로 차단.
...
- [[concept-free-fatty-acid-receptors]] — 병렬/대안 지방 수용체 GPR40/GPR120(장 선호엔 이쪽 필수).
- [[laugerette-2005-cd36-involvement-in-orosensory-detection]] — 구강 CD36 최초 규명.
- [[martin-2011-the-lipid-sensor-candidates-cd36]] — 미뢰 CD36 식이 조절.
- [[moulle-2013-fatty-acid-transporter-cd36-mediates]] — 시상하부 CD36 FA 감지.
- [[li-2022-gut-brain-circuits-for-fat-preference]] — 장 gut-brain 선호엔 CD36 불요(GPR40/120 필수).
- [[concept-ventromedial-hypothalamus]] — 중추 CD36 감지 부위.
- [[concept-vagal-afferent-neurons]] — LCFA 감지 → 미주 신호.
- [[concept-cck]] — LCFA가 CD36/FFAR로 CCK 분비 자극.
