...
## 한 줄 요약
전기자극 artifact-free인 fiber photometry로 [[concept-nucleus-accumbens|NAc]] MSN 활성을 자극 중 직접 읽어, hedonic feeding이 **D1-MSN 특이적 anticipatory ramp**에 의존하고 [[concept-responsive-neurostimulation|responsive DBS]]가 continuous DBS보다 지속·효율적임을 보인 마우스 연구.

## 핵심 내용
- **대상/방법**: 8주 마우스. WT(n=6) NAc 일반 GCaMP6f, Drd1-cre(n=6, D1-MSN), A2a-cre(n=5–6, D2-MSN). 1시간/일 60% 고지방 제한접근(10일)로 hedonic feeding 유도. photometry는 전기자극 artifact에 무영향이라 cDBS vs rDBS를 직접 비교. rDBS=delta 전력 20%↑ 검출 시 10초 자극(NeuroPace RNS-300, 0.1 mA·130 Hz).
- **결과**:
  - 10일째 hedonic feeding 성립, NAc 신호가 고지방 접근 직전 ramp(이동만으론 무).
...
## 관련 페이지
- [[concept-nucleus-accumbens]] — 표적; D1-MSN anticipatory ramp.
- [[concept-responsive-neurostimulation]] — cDBS 대비 rDBS 우월성의 기계론적 근거.
- [[person-halpern-casey]] — 공동 작품(번역 아크의 동물 mechanism).
- [[wu-2018-closing-the-loop-on]] — delta biomarker로 binge 차단(같은 Hemmings Wu, 본 연구의 전편).
- [[wu-2020-brain-responsive-neurostimulation-for-loss]] — 인간 NAc rDBS 프로토콜.
