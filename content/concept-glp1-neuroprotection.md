...
> GLP-1 작용제는 **당뇨·비만 밖에서도 뇌를 보호**할 수 있다는 가설군. 전임상에서 β-amyloid·tau·신경염증·인슐린저항·시냅스 손실을 다면적으로 개선하고, 임상에서 **당뇨 코호트 인지저하 지연(dulaglutide REWIND)·파킨슨병 운동증상 개선(exenatide)·치매 발생 감소** 신호가 축적됨. [[edison-2026-liraglutide-in-mild-to-moderate|ELAD phase 2b]]는 알츠하이머에서 1차 대사 종점은 음성이나 2차 인지·탐색적 뇌위축에서 유리한 신호. 사용자 lab의 [[concept-glp-1|GLP-1 뇌 작용]] 프로그램에 **비만-당뇨를 넘는 뇌 효과**라는 확장축을 제공하되, 근거는 아직 **가설생성 수준**(다중비교·검정력·washout 함정)임을 명시.
