...
> GCGR agonism은 GLP-1과 조합될 때 **에너지소비 증가·간 지질 감소**라는, 식욕억제 일변도를 넘는 이점을 더한다 — 현 incretin이 못 건드린 EE 축의 가장 임상 진전된 접근. 단 고혈당·심박수 위험 때문에 GLP-1R:GCGR **비율 튜닝**이 관건.

# Glucagon receptor (GCGR) agonism

## 한 줄 요약
글루카곤 수용체(GCGR)를 (부분) 활성화하는 전략. 단독은 혈당을 올리지만 GLP-1R 작용과 균형을 맞추면 에너지소비·간 지방 감소로 감량·MASH 개선을 낸다.
...
- [[le-roux-2026-survodutide-once-weekly-for]] · [[kaplan-2026-survodutide-in-adults-with]] — survodutide 임상.
- [[muller-2022-gut-hormone-triple-agonists-clinical]] — triple agonist.
- [[concept-glp-1]] · [[concept-gip]] · [[concept-incretin-effect]] · [[overview-next-gen-incretin-obesity-drugs-2026]] — incretin 맥락.
