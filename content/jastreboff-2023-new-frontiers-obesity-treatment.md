...
> 최형진 랩(NuSH 기반 항비만 landscape)의 지도 역할 리뷰. GLP-1 단독(liraglutide ~5%, semaglutide ~12.5% 위약보정)에서 GIP·glucagon·amylin·CCK·OXM·PYY를 dual/triple RA로 조합하는 흐름을 호르몬·수용체·CNS 발현·개발단계별로 정리. 프레임은 "여러 nutrient-stimulated hormone이 방어된 **fat mass set point를 재설정**한다".

# New Frontiers in Obesity Treatment (Jastreboff & Kushner 2023)

## 한 줄 요약
GLP-1 RA를 축으로 GIP·glucagon·amylin 등을 단독·조합·dual/triple RA로 엮어 비만을 기전 기반 치료하는 새 시대를 개관한 Annual Review of Medicine 2023 리뷰.
...
## 관련 페이지
- [[overview-next-gen-incretin-obesity-drugs-2026]] — 이 리뷰(2023)가 개관한 파이프라인의 2026 후속·종합.
- [[concept-glp-1]] · [[concept-gip]] — 본 리뷰의 축 호르몬·수용체.
- [[concept-incretin-effect]] — GLP-1·GIP glucose-dependent 인슐린 분비 토대.
- [[liskiewicz-2026-glp-1r-gipr-ppar]] — GLP-1R/GIPR 조합 후속 기전.
