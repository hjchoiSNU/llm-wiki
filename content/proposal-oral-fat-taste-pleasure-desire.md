---
title: "[연구계획서] 입에서 느끼는 지방 맛이 음식 쾌락(liking)과 욕망(wanting)을 구동하는가 — orosensory 대 post-ingestive 신호의 분리"
type: proposal
created: 2026-06-08
updated: 2026-06-08
---
...
flowchart LR
  ORAL["입 안 지방 맛\n(orosensory)"]
  GUT["장 지방 영양\n(post-oral)"]
  ORAL -->|즉시 DA| INS["insula·NTS·LH\nliking+wanting 초안"]
  GUT -->|VTA-DA-CCK| ABLA["left aBLA-D1R\n영양가치 학습 ✔"]
  INS --> PL["Pleasure / Motivation\n(쾌락·욕망)"]
  ABLA --> UT["Utility\n(post-oral 영양)"]
  UT -.reshape.-> PL
  INS -.억제.-> ABLA
```
